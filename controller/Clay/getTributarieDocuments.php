...
while ($responseNeedRepeat) {
    ...
    curl_setopt_array($curl, array(
        CURLOPT_URL => "https://api.clay.cl/v1/obligaciones/documentos_tributarios/?guia_despacho=false&rut_empresa=77604901&fecha_desde=2024-06-28&fecha_hasta=&initialize_until=true&limit=200&offset=10",
    ...
    echo "https://api.clay.cl/v1/obligaciones/documentos_tributarios/?guia_despacho=false&rut_empresa=77604901&fecha_desde=2024-06-29&fecha_hasta=&initialize_until=true&limit=200&offset=10";
