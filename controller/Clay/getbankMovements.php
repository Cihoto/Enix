...
while ($responseNeedRepeat) {
    ...
    curl_setopt_array($curl, array(
        CURLOPT_URL => "https://api.clay.cl/v1/cuentas_bancarias/movimientos/?numero_cuenta=$bankAcocuntId&rut_empresa=$busId&limit=200&offset=$offset&fecha_desde=2024-07-10",
